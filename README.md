...
Interactive demo hosted on GitHub Pages: <https://shannonkalei.github.io/minesweeper>.
...
- Save game state
- Optional timer
- WASD keyboard support (current only `tab`, `enter`, and `shift` + `enter` are supported)
